...
def displayimage(img, width, height):
    ...
    canvas.place(x=(1000-width)/2, y=(645-height)/2+35)
...
#메인 코드 부분
window = Tk()
window.geometry("1920x1016")
window.title("미니 포토샵(ver 0.2)")
window.configure(background="#333333")

bgphoto=PhotoImage(file="photoshop2.png") #배경 이미지 준비
...
#하위 메뉴 생성
image3Menu.add_command(label="명도", command=func_bringhtness)
image3Menu.add_separator() #구분선 삽입
image3Menu.add_command(label="채도", command=func_saturation)
image3Menu.add_separator() #구분선 삽입
